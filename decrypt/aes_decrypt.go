...
func Aes_decrypt_scratch_subbytes(ready_to_change_1_dim [4][4]byte) {
	// hex value sbox
	var sbox = [256]byte{
	...
	for i < 16 {
		...
		new_array[i] = []byte(sbox[firststep_array[i]])
		
	}
	return new_array
}
func Aes_decrypt_scratch_shiftrows(ready_to_change_2_Dim []byte) {
